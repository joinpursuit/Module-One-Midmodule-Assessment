...
function temperatureMessage(temp) {
    ...
    if (temp < 32) { return "It's freezing!" } else { return "It\'s alright" }
...
function temperatureMessageUsingTernary(temp) {
    ...
    let below = temp < 32 ? "It's freezing!" : "It\'s alright"
...
function ageMessage(age) {
    ...
    if (age > 18) {
        if (age >= 65) { return "You are a senior" } else if (age > 18) { return "You are an adult" }
